...
let btnPhones = document.querySelector('.phones');
let btnTablets = document.querySelector('.tablets');
let btnTv = document.querySelector('.tv');
...
function getProductMarkup(product) {
    product.forEach(elem => {
        ...
        <div class="product">
            ...
            <div>${elem.price}</div>
            <a href="${elem.id}">Подробнее</a>
        </div>
    `;
        productCard += productEl;
    });
    divProduct.insertAdjacentHTML('afterbegin', productCard);
}
